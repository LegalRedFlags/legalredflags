...
export const cases: CaseStudy[] = [
  {
    ...
    summaryEn:
      "While dealing with a corporate dispute, a family medical emergency, and severe personal stress, the client retained two lawyers on the recommendation of acquaintances. The first lawyer collected nearly RMB 120,000 into a personal bank account with no formal contract; the second collected nearly RMB 200,000, never once appeared in court during the representation, and sent blank invoices. The client has spent years fighting to recover the money and has not recovered a single yuan to date.",
    summaryJa:
      "企業紛争、家族の緊急入院、深刻な心身の不調に見舞われる中、依頼者は知人の紹介で2人の弁護士に依頼した。1人目の弁護士は正式な契約書なしに約12万人民元を個人口座に振り込ませた。2人目の弁護士は約20万人民元を受領したが、代理期間中一度も出廷せず、送られてきた領収書は白紙だった。依頼者は費用の回収のために何年も闘い続けているが、1元も取り戻せていない。",
    timeline: [
      ...
      { date: "第4年", event: "当事人开始自行研究，发现第一位律师当时可能根本不具备执业资格，属于私自收费；第二位律师收费后从未实际履行代理职责，也没有出庭处理事务。打开之前其寄来的信封，竟然发现寄来的发票是一张空白发票。因身体原因及其他官司纠纷，一直不知道该怎么向这两位无良律师维权。" },
      { date: "第5—6年", event: "在其他律师提醒下，当事人开始向律师协会和司法行政部门投诉，附上转账记录、合同、空白发票等证据。经过漫长的等待和多次申诉，两位律师及律所才被正式立案调查。" },
      { date: "至今", event: "调解失败，对方从「愿意退费」变成「一分不退」。多次尝试通过法律途径追偿均受阻。维权仍在继续，未追回任何费用。" },
    ],
    timelineEn: [
      ...
      { date: "Year 4", event: "Filed a complaint with the bar association, attaching transfer records, chat logs, and other evidence." },
  ...
  },
  {
    ...
    timeline: [
      ...
      { date: "第2年", event: "对方公司突然申请破产。当事人调查发现公司在破产前已将大量资产转移到关联方名下。" },
    ...
    timelineEn: [
      ...
      { date: "Year 2", event: "The counterparty company suddenly filed for bankruptcy. The client's investigation found that substantial assets had been transferred to related parties before the filing." },
    ...
    timelineJa: [
      ...
      { date: "2年目", event: "相手方企業が突然破産を申請した。依頼者の調査により、破産申請前に多額の資産が関連当事者に移転されていたことが判明した。" },
  ...
  },
  {
    ...
    timeline: [
      ...
      { date: "转折点", event: "当事人觉察不对，经过多次追问，律师最终承认对方曾多次接触他并给予好处。" },
      { date: "后续", event: "当事人解除委托，更换律师。新律师采取了完全不同的诉讼策略，追查了原律师建议放弃的证据。" },
      { date: "最终", event: "向律师协会投诉原律师，案件在新律师代理下取得重大进展。" },
    ],
    timelineEn: [
      ...
      { date: "Turning point", event: "Growing suspicious, the client pressed the lawyer repeatedly. The lawyer eventually admitted the opposing side had approached him multiple times and offered financial incentives." },
      ...
      { date: "Outcome", event: "Filed a complaint against the original lawyer with the bar association. The case made significant progress under the new lawyer's representation." },
    ],
    timelineJa: [
      ...
      { date: "転機", event: "不審に思った依頼者が繰り返し問い詰めた結果、弁護士は相手方から何度も接触を受け、金銭的な見返りを得ていたことを認めた。" },
